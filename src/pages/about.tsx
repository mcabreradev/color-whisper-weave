            ...
            <Card className="mb-8">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Palette Picker aims to simplify the process of extracting and
                  using color palettes from websites. Our tool helps designers
                  and developers quickly analyze and implement existing color
                  schemes in their own projects.
                </p>
                <p className="text-muted-foreground">
                  Whether you're looking for inspiration or trying to match a
                  specific brand's colors, Palette Picker provides you with the
                  exact colors in formats you can immediately use in your
                  projects.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="space-y-6 mb-12">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Input any website URL into our analyzer. We accept any
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Our algorithm examines the website's CSS, extracts color
                    information, and identifies the primary color scheme.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    like primary, secondary, accent, and background.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Export the palette in your preferred format and see how it
                    looks with common UI components.
                  </p>
                </div>
              </div>
            </div>
