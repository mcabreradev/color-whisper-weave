      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="preview-bg preview-border border-2">
          <CardHeader>
            ...
            <CardDescription>
              Card description with extracted colors
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="preview-text">
              This card is using your extracted color palette.
            </p>
          </CardContent>
          <CardFooter className="flex justify-between">
            <Button className="preview-primary">Primary Button</Button>
            <Button variant="outline" className="preview-border preview-text">
              Outline
            </Button>
          </CardFooter>
        </Card>
        ...
        <div className="space-y-4">
          <Tabs defaultValue="buttons" className="w-full">
            ...
            <TabsContent value="buttons" className="p-4 space-y-4">
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  variant="outline"
                  className="preview-border preview-text"
                >
                  Outline
                </Button>
                <Button variant="ghost" className="preview-text">
                  Ghost
                </Button>
              </div>
            </TabsContent>
          ...
          <div className="p-4 rounded-lg border preview-bg">
            <h3 className="font-medium mb-2 preview-text">
              Typography Example
            </h3>
            <p className="text-sm preview-text">
              This text uses your extracted colors to demonstrate how typography
              would look with your palette.
            </p>
